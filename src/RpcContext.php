...
class RpcContext
{
    ...
    public function unpackNovaAttach($novaAttach)
    {
        ...
        try {
            ...
            if (is_array($ctx)) {
                if (isset($ctx[static::TRACE_KEY])) {
                    $ctx[static::TRACE_KEY] = Json::decode($ctx[static::TRACE_KEY]);
                }
    ...
    public function packNovaAttach()
    {
        try {
            ...
            if (isset($ctx["CAT_TRACE"])) {
                $ctx["CAT_TRACE"] = Json::encode($ctx[static::TRACE_KEY]);
            }
